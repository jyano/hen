...
J=cjs; T= J.Ticker
ct= J.Container.prototype; st=s=p = J.Stage.prototype
ct.st=  function(){
    return this.stage
}
st.du=function(){return this.canvas.toDataURL()}
mouser=function(){
...
dotTalk=function(){
    ...
    p.pen = function self(arg){
        ...
        return self.text}
    J.chalk=function(text, color){
        color = oO('c', color||'white')

        if(O(text)){
            text = 'x: ' + text.x + ', ' + 'y: ' + text.y
        }
        return new J.Text(text, "26px Arial", "white").XY(50,50)
    }
    CHALK=function(){
        ...
        text = J.chalk('some information ....')

        text2=J.chalk('some more').XY(50, 90)
...
ct.bData=function(data){return J.bm( $.i().src($.parseJSON(data))).a2(this)}
ct.M=ct.mug=function(){var ct = this, g=G(arguments),o
    o=N(g[0])?{sc:g[0], fn:g[1]}:{fn:g[0]}
    o.sc=N(o.sc)? o.sc : 1
    o.fn= o.fn||function(){}
    $.G('myMug', function(m){if(!m){alert('!mug')}
        ct.bm(m, o.sc,  o.fn , g.p? '+': null)})
    return ct
}
// duplicate? $Ct= J.container = J.ct  =function(a){ return new J.Container(a)}
ct.clr=function(){var ct=this,arr=[]; ct.ch(function(ch){ch.rm()}); return ct}
ct.cir= function(x,y,r,c){this.A(J.cir(x,y,r,c)); return this}
...
ct.cen=  function(){ return V(this.W()/2, this.H()/2)}
$Ct=function(){return new J.Container()}
...
ct.bm= function(){var ct=this, g = G(arguments), o,bm
    o= N(g[1])? {i:g[0], sc:g[1], fn:g[2]}: { i:g[0], fn:g[1] }
    o.sc= N(o.sc)? o.sc : 1
    if(J.iDU(o.i)){o.i = $.i(o.i)}
...
ct.mc=function(){return  J.mc.apply(null, arguments).a2(this)}
ct.t=ct.tick= function(){T.on('tick', this); return this}
ct.A=function(){var ct=this, g=G(arguments), $b=$('body')

    if(U(g[0]) && ct.st()){ $b.A(
        ct.st().canvas
    )}
    else if(N(g[0])){ $b.A( ct.st().canvas ).abs(g[0],g[1]) }
    else { _.e(g, function(g){ct.addChild(g)})}
    return ct
}
ct.bgI= ct.bg= function(i){var ct =this; ct.bm(i, function(b){ct.setChildIndex(b, 0)}); return ct}
ct.C= ct.bgC=  function(c){$( this.canvas ).C(c); return this}
...
ct.xCh= ct.removeAll=function(){this.e(function(ch){ ch.rm() }); return this}
ct.auCl= ct.noAutoClear=function(){
    this.autoClear = false
    return this}
st.snap = function(f){var st=this
    $.P('img', {d: st.toDataURL()  })//, dats: o.x.dats
    $.in(1, f)
    return st}
st.W=function(a){if(U(a)){return this.canvas.width}; this.canvas.width = a; return this}
st.H=function(a){if(U(a)){return this.canvas.height}; this.canvas.height=a; return this}
st.WH=function(w,h){var st=this; if(U(w)){return V(st.W(), st.H())} if(N(w)){st.W(w)}if(N(h)){st.H(h)}; return st}
st.hW=function(){return this.W()/2}
st.hH=function(){return this.H()/2}
st.ab= st.abs=function(x,y){this.can.abs(x,y); return this}
st.Bm=function(i){return $Bm(i).a2(this)}
st.N= st.next=function(next){if(U(next)){return this.nextStage}; this.nextStage=next; return this}
st.trDr=function(){var st=this
    st._md=0
    st.MD(function () {st._md = 1})
    st.MU(function () {st._md = 0})
    return this
}
old=function(){
...
h.ss=function(a){var h=this,gx= h.graphics, g,o
...
h.dc=function(x,y,r){var h=this,gx= h.graphics
    ...
    return h}
h.mt=function(a,b,c,d,e){var h=this,gx= h.graphics,v
...
h.lt=function(a,b,c,d,e){var h=this,gx= h.graphics,v
...
h.C=h.s=function(a,b,c,d,e,f){var h=this,gx= h.graphics
    if(N(a)){gx.s(  (a>0 && a<1)? J.rgb(0,0,0,a):J.rgb(a,b,c,d) )}
    else if(S(a)){
...
h.c=h.f=function(a,b,c,d,e){var h=this,gx= h.graphics
...
h.qt=function(a,b,c,d,e,f){var h=this,gx= h.graphics
