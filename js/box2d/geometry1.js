...
b2d.newX=newX = function (x, y, r) {r = Math.toRadians(r)

    return x * Math.cos(r) - y * Math.sin(r)
}
b2d.newY=newY = function (x, y, rad) {
    rad = Math.toRadians(rad)
    return x * Math.sin(rad) + y * Math.cos(rad)}
b.vs= b.verts=function(){var b=this
//return this.union()
...
b.polygon = function () {var b=this

    return Math.poly( b.vs() )
}
...
b.V=   b.rotWorVerts=function () {var b = this
        return _.m(b.rotVerts(), function (v) {
